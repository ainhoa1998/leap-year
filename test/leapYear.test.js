...
describe('Kata año bisiesto', () => {
  ...
  it('Si el año es 400, devuelve true', () => {
    const isLeap = leapYear(400)

    expect(isLeap).toBe(true)
  })

  it('Si el año es 800, devuelve true', () => {
    const isLeap = leapYear(800)

    expect(isLeap).toBe(true)
  })

  it('Si el año es 1200, devuelve true', () => {
    const isLeap = leapYear(1200)
